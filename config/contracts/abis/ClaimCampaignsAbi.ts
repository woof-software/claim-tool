export const ClaimCampaignsAbi = [
  {
    inputs: [
      { internalType: 'address payable', name: '_treasury', type: 'address' },
      { internalType: 'string', name: 'name', type: 'string' },
      { internalType: 'string', name: 'version', type: 'string' },
      { internalType: 'address[]', name: '_tokenLockups', type: 'address[]' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'bytes16', name: 'id', type: 'bytes16' },
    ],
    ...
    inputs: [
      { indexed: true, internalType: 'bytes16', name: 'id', type: 'bytes16' },
      {
        components: [
          ...
          { internalType: 'bool', name: 'delegating', type: 'bool' },
        ],
        indexed: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        components: [
          { internalType: 'address', name: 'tokenLocker', type: 'address' },
          { internalType: 'uint256', name: 'start', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'bytes16[]', name: 'campaignIds', type: 'bytes16[]' },
    ],
  ...
  {
    inputs: [
      { internalType: 'bytes16', name: 'campaignId', type: 'bytes16' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'delegatee', type: 'address' },
      {
        ...
        internalType: 'struct ClaimCampaigns.SignatureParams',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address[]', name: 'delegatees', type: 'address[]' },
      {
        components: [
          { internalType: 'uint256', name: 'nonce', type: 'uint256' },
          { internalType: 'uint256', name: 'expiry', type: 'uint256' },
        ...
        internalType: 'struct ClaimCampaigns.SignatureParams[]',
        name: 'delegationSignatures',
        type: 'tuple[]',
      },
    ],
    name: 'claimAndDelegateMultiple',
    outputs: [],
    stateMutability: 'payable',
    type: 'function',
  },
